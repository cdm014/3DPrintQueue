...
class navigationController extends Controller {
	function process() {
		...
		$actions = array("create" => "Create a New Job","home" => "Waiting to be printed","list_printed" => "Waiting for Contact/Pick Up","list_picked_up" => "Already Picked Up" ,"report" => "Reports");
